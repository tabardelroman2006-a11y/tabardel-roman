...
const SERVICES = [
  {
    ...
    desc:
      'Un site professionnel qui présente votre activité, inspire confiance et capte vos prospects. Design unique, mobile-first, rapide.',
  ...
  },
  {
    ...
    desc:
      'Une boutique en ligne qui vend, même quand vous dormez. Tunnel de commande optimisé, gestion de stock intuitive.',
    points: ['Panier & paiement sécurisé', 'Gestion produits simple', 'Emails transactionnels', 'Analytics intégrés'],
  },
  {
    icon:   Search,
    number: '03',
    ...
    price:  'Sur devis',
    desc:
      "Être beau sur internet ne suffit pas — il faut être trouvé. J'optimise votre visibilité pour que Google vous mette devant vos concurrents.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-20 max-w-xl">
          ...
          >
            Trois offres.
            <br />
            <span style={{ color: 'rgba(255,255,255,0.28)' }}>Zéro compromis.</span>
          </motion.h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5">
          {SERVICES.map(({ icon: Icon, number, title, price, desc, points }, i) => (
            <motion.div
              ...
              onMouseEnter={e => (e.currentTarget as HTMLElement).style.borderColor = 'rgba(200,255,0,0.22)'}
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                <ArrowUpRight
                  size={15}
                  style={{ color: 'rgba(255,255,255,0.18)', transition: 'color 0.2s' }}
                />
              </div>
        ...
        >
          ...
          <button
            onClick={openDevis}
            className="font-body font-semibold text-sm px-8 py-3.5 transition-opacity duration-200 hover:opacity-80 shrink-0"
